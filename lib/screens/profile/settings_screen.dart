...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  /// Lets you view every fiche in every role with synthetic data — no
  /// Firestore writes. See CARNET_SCENARIOS_CATALOGUE.md. (WP-25, hersteld
  /// uit 132decb^ en aangepast aan fiche v4.)
