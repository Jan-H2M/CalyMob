...
class OceanTimeColors {
  ...
  static final List<List<double>> _waterTable = [
    [0,    0.05, 0.12, 0.28, 0.03, 0.06, 0.16],
    [6.5,  0.35, 0.68, 0.84, 0.08, 0.20, 0.40],
    [8,    0.40, 0.77, 0.89, 0.09, 0.22, 0.41],
    [12,   0.42, 0.80, 0.91, 0.09, 0.22, 0.41],  // #6BCBE8
    [17,   0.40, 0.76, 0.88, 0.08, 0.20, 0.40],
    [18.5, 0.45, 0.45, 0.50, 0.10, 0.14, 0.30],
    [19.5, 0.15, 0.14, 0.28, 0.05, 0.07, 0.18],
    [21,   0.06, 0.14, 0.30, 0.03, 0.06, 0.16],
    [24,   0.05, 0.12, 0.28, 0.03, 0.06, 0.16],
  ];
